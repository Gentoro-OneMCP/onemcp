...
- [Managing Multiple Handbooks](/docs/guides/handbook-management) - Create and configure multiple AI agents
- [Creating a Foundation Folder](/docs/guides/ingest-foundation) - Set up your agent's knowledge base
- [Adding a Tool](/docs/guides/adding-a-tool) - Extend your agent with custom tools
