...
```
~/handbook
├── Agent.yaml                  # Agent definition will be auto-generated from the given OpenAPI specification
├── Guardrails.yaml             # Guardrail definition will be auto-generated from the given OpenAPI specification
├── apis/
|   └── my-api-service.yaml     # Definition will be downloaed and stored here
├── docs/                       # Documentation present at the OpenAPI definition will be saved here.
└── regression/                 # OneMCP will use its underlying LLM model to generate regression tests automatically, based on the given OpenAPI specification.
```
...
> onemcp handbook validate
    ...
    🚀 Starting handbook validation...
    📁 Foundation directory: /var/handbook
    ============================================================
